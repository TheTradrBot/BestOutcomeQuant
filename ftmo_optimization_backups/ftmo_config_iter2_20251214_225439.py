...
class FTMO200KConfig:
    ...
    risk_per_trade_pct: float = 0.7999999999999999  # Match /backtest command (1% = $2000 per trade on 200K)
    ...
    # === TRADE LIMITS ===
    max_concurrent_trades: int = 9  # Backtest used up to 21, but 10 balances opportunity with risk
